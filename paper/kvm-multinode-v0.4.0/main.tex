...
\midrule
\texttt{k8s-cp-01} & control-plane & \texttt{testbed-role=control-plane} & Kubernetes API and control-plane services \\
\texttt{k8s-worker-01} & worker & \texttt{testbed-role=validator} & Solana validator and ledger PVC \\
\texttt{k8s-worker-02} & worker & \texttt{testbed-role=observability} & Monitor and auxiliary validation jobs \\
\bottomrule
\end{longtable}
