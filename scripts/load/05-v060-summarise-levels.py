...
IN_CSV = ROOT / "results" / "v0.6.0" / "processed" / "v0.6.0-run-summary.csv"
OUT_CSV = ROOT / "results" / "v0.6.0" / "processed" / "v0.6.0-level-summary.csv"
...
def main() -> int:
    ...
    for (level, target), items in sorted(groups.items()):
